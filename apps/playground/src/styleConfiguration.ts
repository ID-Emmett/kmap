...
export const LABEL_OPTIONS = { 国家: 'country-label', 省名: 'province-label', 省会与直辖市: 'capital-label', 城市: 'place-label', 道路: 'road-label', 兴趣点: 'poi-label', 地铁: 'rail_metro', 机场: 'airport', 医疗: 'hospital',
