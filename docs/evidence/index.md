...
[2026-09-20 国省界与地图线样式](map-quality/README.md#2026-09-20-国省界与地图线样式复验)：MapLibre 对齐的国省界视觉层级、省界 zoom 10 排他隐藏、像素宽度缩放曲线、地面挤出透视、overlay 上界裁剪、201 项测试及真实 WebGPU/WebGL2 验证。

[2026-09-20 KYE 近岸海陆权威](maplibre-alignment/coast-authority.md)：主瓦片区域所有权、204 海洋回退、赤柱 50 座建筑地面、台湾同级缩放与逐帧像素验证；197 项测试与人工实测结论。

[2026-09-20 瓦片、道路、文字与海洋内容覆盖](maplibre-alignment/README.md)：canonical 来源、GPU 准备、逐采样点模板所有权、道路缩放曲线、SDF 连续显隐、海洋来源空间范围与同级缩放像素验证；命令、双后端性能与采样边界见报告，指标定义见 glossary。

[2026-09-19 瓦片与文字连续性](map-continuity/README.md)：台湾空主源祖先补全、同级预热、稳定覆盖接替、线缓冲编译稳定性、省名与省会图标、鼠标地理锚点缩放；测试结果、双后端矩阵与限速冷加载见报告和汇总 JSON。

[2026-09-17 运动瓦片白闪与留白](streaming-motion/README.md)：WebGPU 模板编号因果对照、子区域视锥更新、缩放滞回与驻留子级覆盖；165 项测试，双后端逐像素矩阵和独立性能结果由报告与 JSON 索引。
