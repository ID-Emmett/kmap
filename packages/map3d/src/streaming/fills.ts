...
export interface FillData { positions: Float32Array; colors: Float32Array; styles: Float32Array; indices: Uint32Array }
...
export function buildFills(tile: VectorTile, layers: readonly MapLayerOptions[]): FillData & { features: number } {
  ...
  return { positions: new Float32Array(positions), colors: new Float32Array(colors), styles: new Float32Array(styles), indices: new Uint32Array(indices), features };
}
